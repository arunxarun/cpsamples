...
public class GroupViewsByUserMRTest {
	...
	public void testMapperValidInput() throws IOException, InterruptedException {
		...
		Mapper<LongWritable,Text,Text,Text>.Context context = getMapperContext(mapper,rw);
	...
	@Test
	public void testMapperInvalidFormattedInput() throws IOException, InterruptedException {
		GroupViewsByUser.GroupViewsByUserMapper mapper = new GroupViewsByUser.GroupViewsByUserMapper();
		...
		LongWritable key = new LongWritable(1);
		Text value = new Text("1294203732 2011-01-05 00:02:12 2682301003077099295 6917530613557758086 H.15.1 N");
		mapper.map(key, value, context);
		
		assertEquals(1,context.getCounter(GroupViewsByUser.GroupByUserCounters.BAD_LOG_FORMAT).getValue());
	...
	@Test
	public void testReducerValidInput() throws IOException, InterruptedException {
		...
		Reducer<Text, Text, Text, Text>.Context context = reducer.new Context(conf, taskId, drkv, new MockCounter(), new MockCounter(), dwr, doc, dsr, null, Text.class, Text.class);
	...
	// TODO: more tests! 
//	@Test
//	public void testReducerInvalidInput() {
//		
//	}
	 ...
	 */
	private Mapper<LongWritable,Text,Text,Text>.Context getMapperContext(GroupViewsByUser.GroupViewsByUserMapper mapper,MockRecordWriter<Text, Text> rw) throws IOException, InterruptedException {
		Configuration conf = new Configuration();
		TaskAttemptID taskId =  new TaskAttemptID();
		
		Mapper<LongWritable,Text,Text,Text>.Context context = 
			mapper. new Context(conf, taskId, new MockRecordReader<LongWritable,Text>(), rw, 
					new MockOutputCommitter(), new MockStatusReporter(), new MockInputSplit());
